...
INSERT INTO tb_usuarios(usuario, nome, senha, foto, data_nascimento) 
VALUES ("mariaduda@email.com.br", "Maria Eduardada da Silva", "123@456&78", "https://i.imgur.com/mB3VM2N.jpg", "2001-11-22");

INSERT INTO tb_usuarios(usuario, nome, senha, foto, data_nascimento) 
VALUES ("kelly@email.com.br", "Kelly Pereira Almeida", "123l456t78", "https://i.imgur.com/5M2p5Wb.jpg", "2002-12-26");

INSERT INTO tb_usuarios(usuario, nome, senha, foto, data_nascimento) 
VALUES ("fred@email.com.br", "Frederico Souza Campos", "123b456#78", "https://i.imgur.com/Sk5SjWE.jpg", "2003-12-26");

INSERT INTO tb_usuarios(usuario, nome, senha, foto, data_nascimento) 
VALUES ("fernanda@email.com.br", "Fernanda Santos Franco", "123!456?78", "https://i.imgur.com/NtyGneo.jpg", "2002-12-26");

INSERT INTO tb_usuarios(usuario, nome, senha, foto, data_nascimento) 
VALUES ("evelyn@email.com.br", "Evelyn Machado", "123f456v78", "https://i.imgur.com/EcJG8kB.jpg", "2001-12-26");

INSERT INTO tb_usuarios(usuario, nome, senha, foto, data_nascimento) 
VALUES ("gilberto@email.com.br", "Gilberto Firmino Alves", "123@!456g78", "https://i.imgur.com/T12NIp9.jpg", "2000-12-26");
